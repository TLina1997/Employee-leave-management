...
public class RegisterDao {
    ...
    public String authorizeRegister(RegisterBean registerBean) //create authorizeRegister()function
    {
        ...
        try
        {
           ...
           // pstmt=con.prepareStatement("INSERT INTO register(firstname,lastname,username,password) values(?,?,?,?)"); //sql insert query
            pstmt=con.prepareStatement("INSERT INTO `register`(`firstname`, `lastname`, `username`, `password`) values(?,?,?,?)");
